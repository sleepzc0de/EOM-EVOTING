<x-layouts-backend>
  ...
  @if ($errors->any())
    ...
    @endif
    <form id="UserForm" action="/gantipassword" method="POST">
        @csrf
        ...
        <div class="mt-6 flex items-center justify-start gap-x-6">
            <button type="button" class="text-sm font-semibold leading-6 text-gray-900" onclick="window.history.back()">Batal</button>
